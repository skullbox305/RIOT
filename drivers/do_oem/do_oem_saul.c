...
const saul_driver_t do_oem_do_mg_saul_driver1 =
		{ .read = read_do_mg, .write = set_sal_compensation, .type =
				SAUL_SENSE_DO_MG, };

const saul_driver_t do_oem_do_mg_saul_driver2 =
		{ .read = read_do_mg, .write = set_pres_compensation, .type =
				SAUL_SENSE_DO_MG, };

const saul_driver_t do_oem_do_mg_saul_driver3 =
		{ .read = read_do_mg, .write = set_temp_compensation, .type =
				SAUL_SENSE_DO_MG, };

const saul_driver_t do_oem_do_percent_saul_driver1 =
		{ .read = read_do_percent, .write = set_sal_compensation, .type =
		SAUL_SENSE_DO_P, };

const saul_driver_t do_oem_do_percent_saul_driver2 =
		{ .read = read_do_percent, .write = set_pres_compensation, .type =
		SAUL_SENSE_DO_P, };

const saul_driver_t do_oem_do_percent_saul_driver3 =
		{ .read = read_do_percent, .write = set_temp_compensation, .type =
		SAUL_SENSE_DO_P, };
