                           ...
                           ph_ezo_calibration_option_t option)
{
    ...
    if (_write_i2c_ezo(dev, (uint8_t *)calibration_cmd, &value_size) < 0) {
        DEBUG(
            "\n[ph_ezo debug] Setting calibration to option %d with value %f failed\n", option,
